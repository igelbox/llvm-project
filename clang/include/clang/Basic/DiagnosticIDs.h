...
private:
  ...
  /// suppressed.
  bool ProcessDiag(DiagnosticsEngine &Diag, const DiagnosticBuilder &DiagBuilder) const;

  /// Used to emit a diagnostic that is finally fully formed,
  /// ignoring suppression.
  void EmitDiag(DiagnosticsEngine &Diag, const DiagnosticBuilder &DiagBuilder, Level DiagLevel) const;
